...
public class JeuVie extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Récupération des valeurs des SeekBars (envoyées par JeuVieParam)
        Intent intentVal = getIntent();
        int size = intentVal.getIntExtra("size", 20);       // "size" = clé de la valeur
        float density = intentVal.getFloatExtra("density", 0.3f); // "density" = clé

        // Initialisation du jeu avec ces valeurs
